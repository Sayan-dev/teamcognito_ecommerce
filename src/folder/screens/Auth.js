  ...
  return (
    ...
    <View style={styles.container}>
      ...
      <View style={{paddingTop:10,flexDirection:"row",alignItems:"center",justifyContent:"center"}}>
        <View style={{width:"30%",borderWidth:0.5,borderColor:"black",height:1,margin:10 }}></View>
      ...
      <View style={{paddingTop:10,flexDirection:"row",alignItems:"center",justifyContent:"center"}}>
        <View style={{width:"45%",borderWidth:0.5,borderColor:"grey",height:1,margin:5 }}></View>
        <Text>OR</Text>
        <View style={{width:"45%",borderWidth:0.5,borderColor:"black",height:1,margin:5}}></View>
      </View>
